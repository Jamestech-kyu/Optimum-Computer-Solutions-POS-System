...
def callback_url_warning():
    ...
    if not callback_url.startswith('https://'):
        return ' Optimum POS callbacks require a public HTTPS URL.'
...
def send_stk_push(phone_number, amount, account_reference, transaction_description='Optimum POS payment'):
    missing_settings = [
