...
from .models import AppSetting, ApprovalRequest, Branch, OfflineSyncLog, ReportExport, SavedReport, Terminal


@admin.register(AppSetting)
class AppSettingAdmin(admin.ModelAdmin):
    list_display = ('key', 'updated_by', 'created_at', 'updated_at')
    search_fields = ('key', 'updated_by')
