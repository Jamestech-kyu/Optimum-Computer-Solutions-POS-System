...
class UnitSerializer(serializers.ModelSerializer):
    class Meta:
        model = Unit
        fields = ['id', 'name', 'symbol', 'type', 'created_at']
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    variant_unit = UnitSerializer(read_only=True)
    variant_unit_id = serializers.IntegerField(write_only=True, required=False, allow_null=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'images',
            'size', 'variant_unit', 'variant_unit_id',
        ]
        read_only_fields = [
