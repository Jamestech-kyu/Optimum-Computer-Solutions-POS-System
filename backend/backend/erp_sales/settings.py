...
# Python 3.14 compatibility: Django 4.2's template BaseContext.__copy__ uses
# copy(super()) which fails because super() has no __dict__ in Python 3.14.
import django.template.context as _ctx
import copy as _copy
def _patched_base_copy(self):
    duplicate = type(self).__new__(type(self))
    duplicate.dicts = _copy.copy(self.dicts)
    return duplicate
_ctx.BaseContext.__copy__ = _patched_base_copy
_ctx.RenderContext.__copy__ = _patched_base_copy
def _patched_context_copy(self):
    ...
    return duplicate
_ctx.Context.__copy__ = _patched_context_copy
